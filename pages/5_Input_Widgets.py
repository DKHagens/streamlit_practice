...
st.page_link('pages/1_Text_elements.py',
             label='Text elements')
st.page_link('pages/4_Charts.py',
             label='Data elements')
st.page_link('pages/강도훈_streamlit 연습문제.py', label='Exercise',
             disabled=True)
